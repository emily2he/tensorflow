...
tf.app.flags.DEFINE_string('train_data_dir', '/home/amax/hexx/image_db/HWDB1/train/', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', '/home/amax/hexx/image_db/HWDB1/test/', 'the test dataset dir')
...
def build_graph(top_k):
    ...
    conv_1 = slim.conv2d(images, 64, [11, 11], 1, padding='SAME', scope='conv1')
    max_pool_1 = slim.max_pool2d(conv_1, [2, 2], [2, 2], padding='SAME')
    conv_2 = slim.conv2d(max_pool_1, 128, [7, 7], padding='SAME', scope='conv2')
    max_pool_2 = slim.max_pool2d(conv_2, [2, 2], [2, 2], padding='SAME')
    conv_3 = slim.conv2d(max_pool_2, 256, [5, 5], padding='SAME', scope='conv3')
    max_pool_3 = slim.max_pool2d(conv_3, [2, 2], [2, 2], padding='SAME')

    conv_4 = slim.conv2d(max_pool_3, 512, [3, 3],1, padding='SAME', scope='conv4')
    ...
    fc1 = slim.fully_connected(slim.dropout(flatten, keep_prob), 1024, activation_fn=tf.nn.tanh,
                ...
                scope='fc1', reuse=False)
    
#    fc1 = slim.fully_connected(slim.dropout(flatten, keep_prob), 1024, activation_fn=tf.nn.tanh, scope='fc1')
    logits = slim.fully_connected(fc1, FLAGS.charset_size, activation_fn=None, scope='fc2')
...
def train():
    ...
    train_feeder = DataIterator(data_dir='/home/amax/hexx/image_db/HWDB1/train/')
    test_feeder = DataIterator(data_dir='/home/amax/hexx/image_db/HWDB1/test/')
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = '/home/amax/data/train_word_all/test/23029.jpg'
